    ...
    >
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <div className="bg-violet-700 rounded-full w-32 h-32 sm:w-36 sm:h-36 md:w-44 md:h-44 flex flex-col items-center justify-center border-4 border-white shadow-lg order-1 sm:order-2">
      ...
      <div className="bg-gray-800 py-10 sm:py-12 md:py-16 px-4 sm:px-6 mt-6 sm:mt-8">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-white text-xl sm:text-2xl font-extrabold uppercase mb-6 sm:mb-8 md:mb-10">
