  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 lg:left-[calc(25%-200px)] lg:translate-x-0 w-[280px] sm:w-[350px] md:w-[500px] lg:w-[800px]">
        ...
        />
        <button className="absolute bottom-8 sm:bottom-12 md:bottom-16 left-1/2 -translate-x-1/2 z-10 flex items-center gap-3 bg-white/95 backdrop-blur-sm px-4 py-2.5 sm:px-5 sm:py-3 rounded-full shadow-lg hover:bg-white hover:shadow-xl transition-all duration-300 group">
