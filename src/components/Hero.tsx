...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[280px] sm:w-[350px] md:w-[500px] lg:w-[700px] xl:w-[800px]">
        <img
          className="w-full h-auto pointer-events-none"
          src="layer-0-10.png"
          alt="Couple enjoying resort"
        />
        <button className="absolute bottom-[15%] left-1/2 -translate-x-1/2 bg-white rounded-full py-2.5 sm:py-3 px-5 sm:px-6 flex items-center gap-2.5 shadow-lg hover:shadow-xl transition-shadow min-h-[44px] touch-manipulation active:scale-95">
